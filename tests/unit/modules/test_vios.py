...
test_data2 = [
    ...
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'state': 'facts',
      'system_name': None, 'name': 'vmname', 'virtual_optical_media': False},
     "ParameterError: mandatory parameter 'system_name' is missing"),
    # vios name is missing
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'state': 'facts',
      'system_name': 'systemname', 'name': None, 'virtual_optical_media': False},
     "ParameterError: mandatory parameter 'name' is missing"),
    # host is missing
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'state': 'facts',
      'system_name': 'systemname', 'name': "abc", 'virtual_optical_media': False},
     "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # system_name and vios name are missing
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': 'facts',
      'system_name': None, 'name': None, 'virtual_optical_media': False},
     "ParameterError: mandatory parameters 'system_name,name' are missing"),
    # unsupported parameter nim_IP
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': 'facts',
      'system_name': 'sysName', 'name': 'viosName', 'settings': None, 'nim_IP': '1.1.1.1',
...
test_data3 = [
    ...
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': None, 'name': 'vmname', 'virtual_optical_media': False}, "ParameterError: mandatory parameter 'system_name' is missing"),
    # vios name is missing
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'systemname', 'name': None, 'virtual_optical_media': False}, "ParameterError: mandatory parameter 'name' is missing"),
    # host is missing
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'systemname', 'name': "abc", 'virtual_optical_media': False}, "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # system_name and vios name are missing
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': None, 'name': None, 'virtual_optical_media': False}, "ParameterError: mandatory parameters 'system_name,name' are missing"),
    # unsupported parameter nim_IP
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'sysName', 'name': 'viosName', 'settings': None, 'nim_IP': '1.1.1.1',
      'nim_gateway': None, 'vios_IP': None, 'nim_subnetmask': None, 'prof_name': None,
      'location_code': None, 'nim_vlan_id': None, 'nim_vlan_priority': None, 'timeout': None, 'virtual_optical_media': False},
     "ParameterError: unsupported parameter: nim_IP"),
    # unsupported parameter nim_gateway
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'sysName', 'name': 'viosName', 'settings': None, 'nim_IP': None,
    ...
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'sysName', 'name': 'viosName', 'settings': None, 'nim_IP': None,
      'nim_gateway': None, 'vios_IP': None, 'nim_subnetmask': None, 'prof_name': None,
      'location_code': 'abc:xyz:123', 'nim_vlan_id': None, 'nim_vlan_priority': None, 'timeout': None, 'virtual_optical_media': False},
     "ParameterError: unsupported parameter: location_code"),
    # unsupported parameter nim_vlan_id
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'sysName', 'name': 'viosName', 'settings': None, 'nim_IP': None,
      'nim_gateway': None, 'vios_IP': None, 'nim_subnetmask': None, 'prof_name': None,
      'location_code': None, 'nim_vlan_id': '2', 'nim_vlan_priority': None, 'timeout': None, 'virtual_optical_media': False},
     "ParameterError: unsupported parameter: nim_vlan_id"),
    # unsupported parameter nim_vlan_priority
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'sysName', 'name': 'viosName', 'settings': None, 'nim_IP': None,
      'nim_gateway': None, 'vios_IP': None, 'nim_subnetmask': None, 'prof_name': None,
      'location_code': None, 'nim_vlan_id': None, 'nim_vlan_priority': '2', 'timeout': None, 'virtual_optical_media': False},
     "ParameterError: unsupported parameter: nim_vlan_priority"),
    # unsupported parameter timeout
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'sysName', 'name': 'viosName', 'settings': None, 'nim_IP': None,
      'nim_gateway': None, 'vios_IP': None, 'nim_subnetmask': None, 'prof_name': None,
      'location_code': None, 'nim_vlan_id': None, 'nim_vlan_priority': None, 'timeout': 50, 'virtual_optical_media': False},
     "ParameterError: unsupported parameter: timeout"),
    # unsupported parameter settings
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'sysName', 'name': 'viosName', 'settings': "sett", 'nim_IP': None,
    ...
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'state': None, 'action': 'accept_license',
      'system_name': 'sysName', 'name': 'viosName', 'settings': None, 'nim_IP': None,
      'nim_gateway': None, 'vios_IP': None, 'nim_subnetmask': None, 'prof_name': None,
      'location_code': None, 'nim_vlan_id': None, 'nim_vlan_priority': None, 'timeout': None, 'virtual_optical_media': True},
     "ParameterError: unsupported parameter: virtual_optical_media")]
