...
test_data = [
    ...
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': 'update_proc_mem', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': mem_settings,
    ...
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_proc_mem', 'system_name': None, 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: mandatory parameter 'system_name' is missing"),
    # when vm_name key is not mentioned for update_proc_mem action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_proc_mem', 'system_name': 'system_name', 'vm_name': None, 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: mandatory parameter 'vm_name' is missing"),
    # when pv_settings key is not mentioned for update_proc_mem action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_proc_mem', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': None, 'mem_settings': None,
...
test_data1 = [
    ...
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': 'update_pv', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': pv_settings, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # when system_name key is not mentioned for update_pv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_pv', 'system_name': None, 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': pv_settings, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: mandatory parameter 'system_name' is missing"),
    # when vm_name key is not mentioned for update_pv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_pv', 'system_name': 'system_name', 'vm_name': None, 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': pv_settings, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: mandatory parameter 'vm_name' is missing"),
    # when pv_settings key is not mentioned for update_pv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_pv', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': None, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: mandatory parameter 'pv_settings' is missing"),    
    # when proc_settings key is mentioned for update_pv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_pv', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': None,
      'timeout': 123, 'pv_settings': pv_settings, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: unsupported parameter: proc_settings"),
    # when npiv_settings key mentioned for update_pv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_pv', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': None, 'mem_settings': None,
...
test_data2 = [
    ...
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': 'update_npiv', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': npiv_settings, 'vod_settings': None},
     "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # when system_name key is not mentioned for update_npiv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_npiv', 'system_name': None, 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': npiv_settings, 'vod_settings': None},
     "ParameterError: mandatory parameter 'system_name' is missing"),
    # when vm_name key is not mentioned for update_npiv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_npiv', 'system_name': 'system_name', 'vm_name': None, 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': npiv_settings, 'vod_settings': None},
     "ParameterError: mandatory parameter 'vm_name' is missing"),
    # when npiv_settings key is not mentioned for update_npiv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_npiv', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': None, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: mandatory parameter 'npiv_settings' is missing"),    
    # when proc_settings key is mentioned for update_npiv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_npiv', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': None,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': npiv_settings, 'vod_settings': None},
     "ParameterError: unsupported parameter: proc_settings"),
    # when pv_settings key mentioned for update_npiv action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_npiv', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': None, 'mem_settings': None,
      'timeout': 123, 'pv_settings': pv_settings, 'npiv_settings': npiv_settings, 'vod_settings': None},
     "ParameterError: unsupported parameter: pv_settings"),
...
test_data3 = [
    ...
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': 'update_vod', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': vod_settings},
     "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # when system_name key is not mentioned for update_vod action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_vod', 'system_name': None, 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': vod_settings},
     "ParameterError: mandatory parameter 'system_name' is missing"),
    # when vm_name key is not mentioned for update_vod action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_vod', 'system_name': 'system_name', 'vm_name': None, 'proc_settings': proc_settings, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': vod_settings},
     "ParameterError: mandatory parameter 'vm_name' is missing"),
    # when vod_settings key is not mentioned for update_vod action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_vod', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': None, 'mem_settings': mem_settings,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': None},
     "ParameterError: mandatory parameter 'vod_settings' is missing"),    
    # when proc_settings key is mentioned for update_vod action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_vod', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': proc_settings, 'mem_settings': None,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': None, 'vod_settings': vod_settings},
     "ParameterError: unsupported parameter: proc_settings"),
    # when npiv_settings key mentioned for update_vod action
    ({'hmc_host': '0.0.0.0', 'hmc_auth': hmc_auth, 'action': 'update_vod', 'system_name': 'system_name', 'vm_name': 'vm_name', 'proc_settings': None, 'mem_settings': None,
      'timeout': 123, 'pv_settings': None, 'npiv_settings': npiv_settings, 'vod_settings': vod_settings},
     "ParameterError: unsupported parameter: npiv_settings"),
