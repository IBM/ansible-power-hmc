...
test_data1 = [
    ...
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'state': 'absent',
     ...
     " all_resources, max_virtual_slots, advanced_info, min_proc, max_proc, min_proc_unit, max_proc_unit, proc_mode, weight")]
test_data2 = [
    ...
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'action': 'shutdown', 'state': None,
      ...
      'max_proc_unit': '1', 'proc_mode': 'uncapped', 'weight': '124'},
     ...
     " min_proc, max_proc, min_proc_unit, max_proc_unit, proc_mode, weight")]
test_data3 = [
