    ...
    HMC_CMD_OPT = {'LSHMC': {'-N': ' -n ',
                   ...
                   'MKSYSCFG': {'-R': {'LPAR': ' -r lpar', 'PROF': ' -r prof', 'SYSPROF': ' -r sysprof'},
                                ...
                                '-I': {'NAME': 'name', 'PROFILE_NAME': 'profile_name', 'LPAR_ENV': 'lpar_env',
                                       ...
                                       'MIN_PROCS': 'min_procs', 'DESIRED_PROCS': 'desired_procs', 'MAX_PROCS': 'max_procs',
                                       'MIN_PROC_UNITS': 'min_proc_units', 'DESIRED_PROC_UNITS': 'desired_proc_units',
                                       'MAX_PROC_UNITS': 'max_proc_units', 'MIN_PROCS': 'min_procs',
                                       'DESIRED_PROCS': 'desired_procs', 'MAX_PROCS': 'max_procs', 'BOOT_MODE': 'boot_mode',
                                       'SHARING_MODE': 'sharing_mode', 'PROC_MODE': 'proc_mode', 'MEM_MODE': 'mem_mode',
                                       ...
                                       'LPAR_AVAIL_PRIORITY': 'lpar_avail_priority', 'LPAR_NAMES': 'lpar_names',
